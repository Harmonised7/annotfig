...
public class ConfigProcessor
{
    ...
    private static final String configPath = "annotfig.toml";
    ...
    private static Map<String, Field> getFields( Class configClass )
    {
    ...
    private static void parseConfig( Class configClass )
    {
        ...
        Map<String, Field> fields = getFields( configClass );
